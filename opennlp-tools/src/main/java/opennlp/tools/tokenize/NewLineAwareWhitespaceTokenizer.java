 ...
 */
public class NewLineAwareWhitespaceTokenizer extends AbstractTokenizer {

  /**
   * Use this static reference to retrieve an instance of the
   * {@link NewLineAwareWhitespaceTokenizer}.
   */
  public static final NewLineAwareWhitespaceTokenizer INSTANCE = new NewLineAwareWhitespaceTokenizer();

  /**
   * Use the {@link NewLineAwareWhitespaceTokenizer#INSTANCE} field to retrieve an instance.
   */
  private NewLineAwareWhitespaceTokenizer() {
  }
